...
//     const selectedCoffee = useSelector((state) => state.items.kahve);
//     useEffect(() => {
...
//                                             {e.product_name === 'Türk Kahvesi' && <div>{selectedCoffee}</div>} {/* selectedCoffee değişkenini sadece Türk Kahvesi siparişlerinde görüntüle */}
//                                         </div>
//                                     </div>
//                                 </li>
//                             )
//                         }
//                         else {
//                             return null; // Diğer siparişlerin görüntülenmemesi için null döndür
//                         }
//                     })
//                 }
//             </ul>
...
// sipariş gönderildikten sonra dispatch'i sıfırlamak lazım onu da hallederiz bide database işlemlerine girişmek lazım
// böyle olmuyor.
import { TextField } from '@mui/material';
import axios from 'axios';
import { useEffect, useState } from 'react';
