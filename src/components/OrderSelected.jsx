...
import success from "../assets/animation/sucesssful.json";
  ...
  return (
    <div className="row d-flex justify-content-center">
      <div className="col-12 mt-5 w-50">
        <ul className="list-group">
          {items.map((e, i) => (
            ...
            >
              ...
              <div className="col-2">
                {e === "Türk Kahvesi" ? (
                  <div className="badge destroy rounded-pill">
                    <Button
        ...
        <Button onClick={handleSend} className="w-100 mt-3" variant="success">
